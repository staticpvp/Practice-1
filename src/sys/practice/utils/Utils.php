...
class Utils {
	 ...
	 * @return string
	 */
	public static function translateColors($string, $symbol = "&"): string {
	 ...
	 * @return array
	 */
	public static function getTrace($start = 1, $trace = null): array {
		if ($trace === null) {
	 ...
	 */
	public static function hash($salt, $password): string {
